...
class AttractionController extends Controller
{
	...
	*/
	...
	{
		$attractions = Attraction::all();
		return view ('attraction.admin',['attractions'=>$attractions]);
	}
	...
	*/
	...
	{
		$request->validate(['name' => 'required','xp_gain' => 'required','description' => 'required','background_image' => 'required','background_image_alt' => 'required','logo' => 'required','logo_alt' => 'required','restriction' => 'required']);
		...
		$attraction = new Attraction(['name' => $request->get('name'),'xp_gain' => $request->get('xp_gain'),'description' => $request->get('description'),'background_image' => $background_image,'background_image_alt' => $request->get('background_image_alt'),'logo' => $logo,'logo_alt' => $request->get('logo_alt'),'restriction' => $request->get('restriction')]);
		$attraction->save();
	...
	*/
	public function update(Request $request, $id)
	{
		...
		$attraction->fill(['name','xp_gain','description','background_image_alt','logo_alt','restriction']);
